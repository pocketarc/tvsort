...
export default async function Image() {
    ...
    return new ImageResponse(
        (
            ...
            >
                <h1 style={{ fontFamily: "Bebas", fontSize: "128px", lineHeight: "1.375", margin: "0px" }}>📺 TV Sort 📺</h1>
                <h2 style={{ fontFamily: "Inter", fontSize: "48px", lineHeight: "1.375", margin: "0px" }}>Which episode is -actually- your favourite? 🤔</h2>
            </div>
        ),
        {
            ...size,
